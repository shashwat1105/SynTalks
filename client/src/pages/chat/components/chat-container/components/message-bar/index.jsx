...
if(selectedChatType==="contact"){
  ...
  return (
    <div className="h-[10vh] bg-[#1c1d25] flex justify-center items-center px-8 mb-8 gap-6">
      ...
      className="bg-[#8417ff] rounded-md flex justify-center items-center p-5 hover:bg-[#741bda] focus:bg-[#8417ff] focus:border-none focus:outline-none focus:text-white duration-300 transition-all">
