...
const EmptyChatContainer = () => {
  return (
    <div className="flex-1 md:bg-[#1c1d25] md:flex duration-1000 transition-all flex-col justify-center items-center hidden">
        ...
        <div className="text-opacity-80 text-white gap-5 items-center mt-10 lg:text-4xl text-3xl transition-all duration-300 text-center ">
            <h3 className="poppins-medium">
                Hi <span className="text-purple-500">! </span>Welcome to 
                <span className="text-purple-500"> SynTalks </span>Chat App <span className="text-purple-500">.</span>
            </h3>
        </div>
        </div>
  )
